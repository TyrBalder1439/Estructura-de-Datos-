...
public class NodosMain {
    public static void main(String[] args) {
        ...
        System.out.print("null|\n");
        System.out.println("integrando 700 al final del codigo");
        ...
        System.out.println("agregando nuevo nodo");
        
        head2.setSiguiente(new Nodo<>(50,head2.getSiguiente().getSiguiente().getSiguiente().getSiguiente().getSiguiente()));
